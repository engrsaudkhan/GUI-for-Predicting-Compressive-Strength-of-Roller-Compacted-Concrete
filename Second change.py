...
class RangeInputGUI:
    ...
    def calculate_G_Bagging_regressor(self):
        ...
        try:
            base_dir = r"C:\Users\MUHAMMAD SAUD KHAN\Documents\Waleed\software-and-prediction-main\V1 GUI for Predicting Compressive Strength of Roller Compacted Concrete\GUI for Predicting Compressive Strength of Roller Compacted Concrete"
            filename = r"RCC.xlsx"
